...
const ENV_KEY = 'APPWRITE_COLLECTION_LEADERSHIP_ID';
...
const COLLECTION_NAME = 'Leadership';
...
const attributes = [
  ...
  { key: 'socialLinkedin', type: 'string', size: 512, required: false },
  { key: 'socialTwitter', type: 'string', size: 512, required: false },
